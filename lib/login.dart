...
import 'package:safety_app/home_screen.dart';
import 'package:safety_app/registration.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:velocity_x/velocity_x.dart';
import 'package:safety_app/applogo.dart';
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFFFFC1CC), Color(0xFFFF9A8B)], // Deep Rose to Sunset Orange
